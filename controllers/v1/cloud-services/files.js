...
module.exports = class Files {
    ...
    */
    ...
    /**
     * @api {post} /kendra/api/v1/cloud-services/files/customBucketUrls
     ...
     * @apiSampleRequest /kendra/api/v1/cloud-services/files/customBucketUrls
     * @apiUse successBody
     * @apiUse errorBody
     * @apiParamExample {json} Response:
     * * {
    ...
    */
    ...
    /**
      * @description                - Get custom bucket urls.
      * @method
      * @name                       - customBucketUrl
      * @param  {Request}  req      - request body.
      * @returns {JSON}             - Response with status and message.
    */
