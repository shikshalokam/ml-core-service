...
module.exports = class Files {
    ...
    */
    ...
    /**
     * @api {post} /kendra/api/v1/cloud-services/files/bucketSpecificUrl?urlType=presignedUrl/downloadableUrl
     * Get custom bucket URL.
     * @apiVersion 1.0.0
     * @apiGroup Files
     * @apiHeader {String} X-authenticated-user-token Authenticity token
     * @apiParamExample {json} Request:
     * {
            ...
            "expiresIn": 262500 //min
        }
     * @apiSampleRequest /kendra/api/v1/cloud-services/files/bucketSpecificUrl?urlType=presignedUrl/downloadableUrl
     * @apiUse successBody
     * @apiUse errorBody
     * @apiParamExample {json} Response:
     * * {
    ...
    */
    ...
    /**
      * @description                - Get bucketSpecificUrl urls.
      * @method
    ...
    */
    ...
    async bucketSpecificUrl(req) {
        return new Promise(async (resolve, reject) => {
            try {
                let customBucketUrl =
                await filesHelpers.bucketSpecificUrl(
                    req.query.urlType,
                    req.body,
                );
